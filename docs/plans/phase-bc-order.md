...
### T-L3c+ (not yet scoped)
After T-L3b: 21 abstract classes, then 121 View/ViewGroup/Drawable/Adapter subclasses (stateful, need
device-test), then 280 plain classes (need finer sort). Scope when reached.
