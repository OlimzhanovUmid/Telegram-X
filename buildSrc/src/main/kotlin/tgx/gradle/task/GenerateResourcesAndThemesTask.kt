...
open class GenerateResourcesAndThemesTask : BaseTask() {
  ...
  fun generateResourcesAndThemes () {
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeId.kt") { kt ->
      kt.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
        ...
        annotation class ThemeId {
          companion object {
            ...
            ${themesList.joinToString("\n            ") { "const val ${it.idName} = ${it.id}" }}

            const val ID_MIN = ThemeId.${themesList[0].idName}
            const val ID_MAX = ThemeId.${themesList[themesList.size - 1].idName}
            const val COUNT = ID_MAX - ID_MIN + 1
          }
        }
      """.trimIndent())
    }
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/PropertyId.kt") { kt ->
      kt.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
        ...
        annotation class PropertyId {
          companion object {
            const val NONE = 0
            ${
              themeProperties.mapIndexed { index, propertyId ->
                "const val ${propertyId.camelCaseToUpperCase()} = ${index + 1}"
              }.joinToString("\n            ")
            }
          }
        }
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ColorIdTinted.kt") { kt ->
      kt.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
        ...
        annotation class ColorIdTinted
      """.trimIndent())
    }
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/PorterDuffColorId.kt") { kt ->
      kt.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014 (tgx-android@pm.me)
        ...
        annotation class PorterDuffColorId
      """.trimIndent())
    }
